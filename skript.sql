...
CREATE TABLE IF NOT EXISTS `mydb`.`album_song` (
  ...
  INDEX `fk_album_has_song_album1_idx` (`album_id` ASC) VISIBLE,
  UNIQUE INDEX `id_alb_song_UNIQUE` (`id_alb_song` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`user_playlist` (
  ...
  UNIQUE INDEX `id_us_pl_UNIQUE` (`id_us_pl` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`song_playlist` (
  ...
  UNIQUE INDEX `id_song_pl_UNIQUE` (`id_song_pl` ASC) VISIBLE,
